...
class Worker(QtCore.QThread):
    ...
    def __init__(self, vertices, lines, graph, parent=None, default_col = None, mst_col = None):
        ...
        self.lines = lines
        self.graph = graph
        self.DEFAULT_EDGE_COLOR = (255,255,255,32,1) if not default_col else default_col
